...
```
    ...
    Info: Working in directory C:/Users/soysa/Documents/BIMM143/bimm143_github/class14
...
![](hsa04110.pathview.png) ![](hsa04142.pathview.png)
...
keggrespathways <- rownames(keggres$les)[1:5]
...
It looks like the mitotic spindle checkpoint has the most significant
p-value.

The most definitely do. They all relate to fundamental cell division /
life cycle processes.

Differences could occur based on methodology/design decisions in the two
approaches.
